...
export type Prompt = {
  ...
  id: string,
  question: string,
  mobileLegendsCharacter?: MobileLegendsCharacter | null,
...
export type CreateChatroomStateInput = {
  chatroomId: string,
  mode?: string | null,
  currentState?: string | null,
  promptId?: string | null,
...
export type UpdateChatroomStateInput = {
  id: string,
  chatroomId?: string | null,
  mode?: string | null,
  promptId?: string | null,
...
export type DeleteChatroomStateInput = {
  id: string,
};
...
export type TableChatroomMessageFilterInput = {
  ...
  chatroomUserId?: TableIDFilterInput | null,
  chatroomId?: TableIDFilterInput | null,
...
export type TablePromptFilterInput = {
  id?: TableIDFilterInput | null,
  question?: TableStringFilterInput | null,
  ...
  timeLimit?: TableIntFilterInput | null,
...
export type PromptConnection = {
  ...
  items?:  Array<Prompt | null > | null,
  nextToken?: string | null,
};

export type TableChatroomStateFilterInput = {
  id?: TableIDFilterInput | null,
  chatroomId?: TableIDFilterInput | null,
  mode?: TableStringFilterInput | null,
  currentState?: TableStringFilterInput | null,
  willEndAt?: TableStringFilterInput | null,
  gameDuration?: TableIntFilterInput | null,
  round?: TableIntFilterInput | null,
  maxPoints?: TableIntFilterInput | null,
  ttl?: TableIntFilterInput | null,
};

export type ChatroomStateConnection = {
  __typename: "ChatroomStateConnection",
  items?:  Array<ChatroomState | null > | null,
  nextToken?: string | null,
};
...
export type CreateChatroomStateMutationVariables = {
  input: CreateChatroomStateInput,
};

export type CreateChatroomStateMutation = {
  createChatroomState?:  {
    __typename: "ChatroomState",
    id: string,
    chatroomId?: string | null,
...
export type UpdateChatroomStateMutationVariables = {
  input: UpdateChatroomStateInput,
};

export type UpdateChatroomStateMutation = {
  updateChatroomState?:  {
    __typename: "ChatroomState",
    id: string,
    chatroomId?: string | null,
...
export type DeleteChatroomStateMutationVariables = {
  input: DeleteChatroomStateInput,
};

export type DeleteChatroomStateMutation = {
  deleteChatroomState?:  {
    __typename: "ChatroomState",
    id: string,
    chatroomId?: string | null,
...
export type ListPromptsQueryVariables = {
  filter?: TablePromptFilterInput | null,
  limit?: number | null,
  nextToken?: string | null,
};
...
export type GetChatroomStateQueryVariables = {
  id: string,
};

export type GetChatroomStateQuery = {
  getChatroomState?:  {
    __typename: "ChatroomState",
    id: string,
    chatroomId?: string | null,
...
export type ListChatroomStatesQueryVariables = {
  filter?: TableChatroomStateFilterInput | null,
  limit?: number | null,
  nextToken?: string | null,
};

export type ListChatroomStatesQuery = {
  listChatroomStates?:  {
    __typename: "ChatroomStateConnection",
    items?:  Array< {
      __typename: "ChatroomState",
...
export type OnCreateChatroomStateSubscriptionVariables = {
  id: string,
};

export type OnCreateChatroomStateSubscription = {
...
export type OnUpdateChatroomStateSubscriptionVariables = {
  id: string,
};

export type OnUpdateChatroomStateSubscription = {
...
export type OnDeleteChatroomStateSubscriptionVariables = {
  id: string,
};

export type OnDeleteChatroomStateSubscription = {
