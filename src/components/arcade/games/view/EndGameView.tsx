...
export default function EndGameViewInput(  {winnerId, timer, chatroomState, chatroomUsers} : EndGameViewInput){
    ...
    return <div className="h-full w-full flex flex-col align-bottom">
        ...
        <div className="my-auto text-6xl text-orange-200">
            ...
            <br />
            Next Round Starts in : {Math.floor(timer/1000)}
        </div>
        ...
        <button className='w-52 align-bottom my-auto mb-[5%] border-1 border-white mx-auto' onClick={handleClickStartGame}>
            ...
            :
            <div className='font-nova h-[30px]  text-lg text-wrap text-shadow drop-shadow-[0_2px_1px_rgba(0,0,0,0.3)] shadow-black'>Play Again</div>
