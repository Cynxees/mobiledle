...
export default function Extra({chatroomState, chatroomUser, chatroomMessages, prompt, round, timer} : LobbyViewInput) {
    ...
    return <div className="h-full w-full grid grid-rows-10 pb-2">
        ...
        <div className="h-full w-full flex flex-col leading-tight">
            <span className="text-3xl">BLUR <span className="text-orange-300">+</span></span>
        ...
        imgKey={answer.imageKeys.extras[skinIndex % answer.imageKeys.extras.length]} 
        />
