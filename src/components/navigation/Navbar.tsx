      ...
      <nav className="flex justify-center items-center w-full gap-5 md:gap-10">
        ...
        <div className="flex gap-3 mx-auto">
          ...
          <a href="https://ko-fi.com/cynxx">
            <img className="w-12 h-12 bg-[#00b9fe] rounded-full" src="/images/kofi_logo.png" alt="" />
          </a>
          <a href="https://instagram.com/mobiledle">
            <img className="h-14 w-14 -translate-y-1" src="/images/instagram_logo.png" alt="" />
          </a>
          <a href="https://www.youtube.com/@Mobiledle">
            <img className="h-12" src="/images/youtube_logo.svg" alt="" />
          </a>
          <a href="https://www.tiktok.com/@mobiledle">
            <img className="h-12" src="/images/tiktok_logo.png" alt="" />
          </a>
          <a href="https://trakteer.id/cynxees/tip">
            <img className="h-12 rounded-full bg-white" src="/images/trakteer_icon.png" alt="" />
          </a>
        </div>
    </div>
  );
